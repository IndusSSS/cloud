#!/usr/bin/env python3
"""
Standalone Secure Admin Account Creation Script

This script deletes all existing admin users and creates a new secure admin account
with industry-standard security measures to prevent brute force attacks.
...
try:
    ...
    print("This script requires the SmartSecurity Cloud application to be properly configured.")
...
async def main():
    ...
    try:
        ...
        if not DATABASE_AVAILABLE:
            ...
            print("Please ensure the SmartSecurity Cloud application is properly configured.")
            return
        ...
        print("• Set up account lockout after failed attempts")
